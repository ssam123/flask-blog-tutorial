...
class Blog(db.Model):
    ...
    #tells blog model that requesting posts shold return all posts from blog 
    #lazy='dynamic' returns all posts if specified
...
class Post(db.Model):
    ...
    #identifier for the URL of the article
    #title of article made URL compatible
    slug = db.Column(db.String(256), unique=True)
    #datetime stores the date and time info
    publish_date = db.Column(db.DateTime)
    #records are not usually deleted
    ...
    def __init__(self, blog, author, title, body, category, image=None, slug=None, publish_date=None, live=True):
        #pass the actual blog/author object rather than an ID becasue ID can change       
